<?php
$successful_transactions = getPayments();
$completed_sales = getSales();
?><!-- begin:: Subheader -->
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<div class="kt-subheader__breadcrumbs">
										...
										<a href="<?php echo base_url()?>" class="kt-subheader__breadcrumbs-link">
											Dashboard </a>
										<span class="kt-subheader__breadcrumbs-separator"></span>
								...
								<div class="kt-subheader__toolbar">
									<div class="kt-subheader__wrapper">
										<a href="javascript:;" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-toggle="kt-tooltip1" title="" data-placement="left">
										...
										<div class="dropdown dropdown-inline" data-toggle="kt-tooltip" title="Quick actions" data-placement="left">
											<a href="<?php echo base_url()?>" class="btn btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											...
											<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
												...
												<ul class="kt-nav">
													...
													<li class="kt-nav__item">
														<a href="<?php echo getPageUrl('sale_form');?>" class="kt-nav__link">
															<i class="kt-nav__link-icon flaticon2-drop"></i>
															<span class="kt-nav__link-text">Sale</span>
														</a>
													</li>
													<li class="kt-nav__item">
														<a href="<?php echo getPageUrl('new_purchase');?>" class="kt-nav__link">
															<i class="kt-nav__link-icon flaticon2-calendar-8"></i>
															<span class="kt-nav__link-text">Purchase</span>
														</a>
													</li>
													<li class="kt-nav__item">
														<a href="<?php echo getPageUrl('manage_transactions');?>" class="kt-nav__link">
															<i class="kt-nav__link-icon flaticon2-telegram-logo"></i>
															<span class="kt-nav__link-text">Payment</span>
														</a>
													</li>
													<li class="kt-nav__item">
														<a href="<?php echo getPageUrl('new_expenditure');?>" class="kt-nav__link">
															<i class="kt-nav__link-icon flaticon2-new-email"></i>
															<span class="kt-nav__link-text">Expense</span>
													...
													<li class="kt-nav__foot">
														<a class="btn btn-label-brand btn-bold btn-sm" href="<?php echo base_url();?>">Upgrade plan</a>
														<a class="btn btn-clean btn-bold btn-sm" href="<?php echo base_url();?>" data-toggle="kt-tooltip" data-placement="right" title="Click to learn more...">Learn more</a>
													</li>
												</ul>
        ...
        <div class="kt-portlet kt-portlet--fit kt-portlet--head-lg kt-portlet--head-overlay kt-portlet--skin-solid kt-portlet--height-fluid">
            <div class="kt-portlet__head kt-portlet__head--noborder kt-portlet__space-x">
                ...
                <div class="kt-portlet__head-toolbar">
                    <a href="<?php echo base_url()?>" class="btn btn-label-light btn-sm btn-bold dropdown-toggle" data-toggle="dropdown">
                        Export
                    </a>
                    <!-- <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                        <ul class="kt-nav">
                            ...
                            <li class="kt-nav__item">
                                <a href="<?php echo base_url()?>" class="kt-nav__link">
                ...
                <div class="kt-widget17">
                    ...
                    <div class="kt-widget17__stats">
                        <div class="kt-widget17__items">
                            <div class="kt-widget17__item" onclick="window.location='<?php echo getPageUrl('sale_report');?>'">
                                ...
                                <span class="kt-widget17__desc">
                                    <?php echo getSalesTotal()?>
                                </span>
                            </div>
                            <div class="kt-widget17__item" onclick="window.location='<?php echo getPageUrl('manage_transactions');?>'">
                                <span class="kt-widget17__icon">
                                ...
                                <span class="kt-widget17__desc">
                                    <?php echo getPaymentsTotal()?>
                                </span>
                            </div>
                        </div>
                        <div class="kt-widget17__items">
                            <div class="kt-widget17__item" onclick="window.location='<?php echo getPageUrl('ledgers');?>'">
                                <span class="kt-widget17__icon">
                                ...
                                <span class="kt-widget17__desc">
                                    <?php echo getReceivablesTotal();?>
                                </span>
                            </div>
                            <div class="kt-widget17__item" onclick="window.location='<?php echo getPageUrl('stock_report');?>'">
                                <span class="kt-widget17__icon">
    ...
    <div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">
        ...
        <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
            <div class="kt-portlet__head kt-portlet__space-x">
                ...
                <div class="kt-portlet__head-toolbar">
                    <a href="javascript:;" class="btn btn-label-success btn-sm btn-bold dropdown-toggle" data-toggle="dropdown1">
                        Payments
                    </a>
                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                        <ul class="kt-nav">
            ...
            <div class="kt-portlet__body kt-portlet__body--fluid">
                <div class="kt-widget20">
                    <div class="kt-widget20__content kt-portlet__space-x">
                        <a href="<?php echo getPageUrl('manage_transactions');?>"><span class="kt-widget20__number kt-font-brand"><?php echo $successful_transactions?></span></a>
        ...
        <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
            <div class="kt-portlet__head kt-portlet__space-x">
                ...
                <div class="kt-portlet__head-toolbar">
                    <a href="javascript:;" class="btn btn-label-warning btn-sm  btn-bold dropdown-toggle" data-toggle="dropdown1">
                        Sales
                    </a>
                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                        <ul class="kt-nav">
            ...
            <div class="kt-portlet__body kt-portlet__body--fluid">
                <div class="kt-widget20">
                    <div class="kt-widget20__content kt-portlet__space-x">
                        <a href="<?php echo getPageUrl('sale_report');?>"><span class="kt-widget20__number kt-font-danger"><?php echo $completed_sales;?></span></a>
                        <span class="kt-widget20__desc">Completed sales</span>
                    </div>
                    <div class="kt-widget20__chart" style="height:130px;">
                    ...
                    <div class="dropdown dropdown-inline">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md">
                            ...
                            <ul class="kt-nav">
                                ...
                                <li class="kt-nav__separator"></li>
                                <li class="kt-nav__foot">
                                    <a class="btn btn-label-danger btn-bold btn-sm" href="<?php echo base_url()?>">Upgrade plan</a>
                                    <a class="btn btn-clean btn-bold btn-sm" href="<?php echo base_url()?>" data-toggle="kt-tooltip" data-placement="right" title="Click to learn more...">Learn more</a>
                                </li>
                            </ul>
            ...
            <div class="kt-portlet__body">
                ...
                <div class="kt-timeline-v2">
                    <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                        <?php 
                            $sales = getSalesList();
                            if(isset($sales) && is_array($sales) && count($sales) > 0)
                            foreach($sales as $sale){
                                $q_customer = "select customer_name from ".$rodb->prefix."customers where customer_id = '".$sale['customerid']."'";
                            ?>
                        <div class="kt-timeline-v2__item">
                        <a href="<?php echo getPageUrl("find_bill")?>&rtno=<?php echo $sale['rtno'];?>&find_bill=Find" target="_blank"><span class="kt-timeline-v2__item-time">#<?php echo $sale['rtno'];?></span></a>
                            <div class="kt-timeline-v2__item-cricle">
                                <i class="fa fa-genderless kt-font-success"></i>
                            </div>
                            <div class="kt-timeline-v2__item-text  kt-padding-top-5">
                            <?php echo $sale['gTotal'];?>/-
                            <a href="<?php echo getPageUrl("account_ledger&customerid=".$sale['customerid'])?>" target="_blank"><?php echo $rodb->getCellFromDB($q_customer);?></a>
                            </div>
                        </div>
                        <?php } ?>
                        <?php 
                        ...
                        <div class="kt-timeline-v2__item">
                            <span class="kt-timeline-v2__item-time"><?php echo ($payment['payment'] > 0)?"Received":'Sent';?></span>
                            <div class="kt-timeline-v2__item-cricle">
                            ...
                            <?php echo ($payment['payment'] > 0)?ro_round($payment['payment']):-ro_round($payment['payment']);?>
                            </div>
                        </div>
                        <?php } ?>
    ...
    <div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">
        ...
        <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
            <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(<? themeUrl()?>assets/media//products/product4.jpg)">
                    <h3 class="kt-widget19__title kt-font-light">
                        Coming Soon
                    </h3>
                    <div class="kt-widget19__shadow"></div>
                    <div class="kt-widget19__labels">
                        <a href="<?php echo base_url()?>" class="btn btn-label-light-o2 btn-bold ">Recent</a>
                    </div>
                </div>
            </div>
            <div class="kt-portlet__body">
                <div class="kt-widget19__wrapper">
                    <div class="kt-widget19__content">
                        <div class="kt-widget19__userpic">
                            <img src="<? themeUrl()?>assets/media//users/user1.jpg" alt="">
                        </div>
                        <div class="kt-widget19__info">
                            <a href="<?php echo base_url()?>" class="kt-widget19__username">
                                Sajid
                            </a>
                        ...
                        <div class="kt-widget19__stats">
                            ...
                            <a href="<?php echo base_url()?>" class="kt-widget19__comment">
                                Comments
                            </a>
                        </div>
                    </div>
                    <div class="kt-widget19__text">
                        We provide the best online/offline accounts solutions all businesses.
                    </div>
                </div>
                <div class="kt-widget19__action">
                    <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-brand btn-bold">Read More...</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="tab-pane active" id="kt_widget5_tab1_content" aria-expanded="true">
                        <div class="kt-widget5">
                            <div class="kt-widget5__item">
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__pic">
                                        <img class="kt-widget7__img" src="<? themeUrl()?>assets/media//products/product27.jpg" alt="">
                                    </div>
                                    <div class="kt-widget5__section">
                                        <a href="<?php echo base_url()?>" class="kt-widget5__title">
                                            Great work
                                        </a>
                                        <p class="kt-widget5__desc">
                                            Youaccounts solutions.
                                        </p>
                                        <div class="kt-widget5__info">
                                            <span>Author:</span>
                                            <span class="kt-font-info">Youaccounts</span>
                                            <span>Released:</span>
                                            <span class="kt-font-info">23.08.2007</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="kt-widget5__content">
                            ...
                            <div class="kt-widget5__item">
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__pic">
                                        <img class="kt-widget7__img" src="<? themeUrl()?>assets/media//products/product22.jpg" alt="">
                                    </div>
                                    <div class="kt-widget5__section">
                                        <a href="<?php echo base_url()?>" class="kt-widget5__title">
                                            Youaccounts
                            ...
                            <div class="kt-widget5__item">
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__pic">
                                        <img class="kt-widget7__img" src="<? themeUrl()?>assets/media//products/product15.jpg" alt="">
                                    </div>
                                    <div class="kt-widget5__section">
                                        <a href="<?php echo base_url()?>" class="kt-widget5__title">
                                            Awesome Mobile View
                                        ...
                                        <p class="kt-widget5__desc">
                                            Youaccounts for Garments.
                                        </p>
                                        <div class="kt-widget5__info">
                                            <span>Author:</span>
                                            <span class="kt-font-info">Fly Accounts</span>
                                            <span>Released:</span>
                                            <span class="kt-font-info">23.08.2007</span>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane" id="kt_widget5_tab2_content">
                        <div class="kt-widget5">
                            <div class="kt-widget5__item">
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__pic">
                                        <img class="kt-widget7__img" src="<? themeUrl()?>assets/media//products/product10.jpg" alt="">
                                    </div>
                                    <div class="kt-widget5__section">
                                        <a href="<?php echo base_url()?>" class="kt-widget5__title">
                                            Branding 
                            ...
                            <div class="kt-widget5__item">
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__pic">
                                        <img class="kt-widget7__img" src="<? themeUrl()?>assets/media//products/product11.jpg" alt="">
                                    </div>
                                    <div class="kt-widget5__section">
                                        <a href="<?php echo base_url()?>" class="kt-widget5__title">
                                            Awesome Mobile View
                            ...
                            <div class="kt-widget5__item">
                                <div class="kt-widget5__content">
                                    <div class="kt-widget5__pic">
                                        <img class="kt-widget7__img" src="<? themeUrl()?>assets/media//products/product6.jpg" alt="">
                                    </div>
                                    <div class="kt-widget5__section">
                                        <a href="<?php echo base_url()?>" class="kt-widget5__title">
                                            Youaccounts for outlets
                                        </a>
                                        <p class="kt-widget5__desc">
                                            Youaccounts admin.
                                        </p>
                            ...
                            <div class="kt-widget5__item">
                                <div class="kt-widget5__content">
                                    ...
                                    <div class="kt-widget5__section">
                                        ...
                                        <p class="kt-widget5__desc">
                                            Youaccounts business solutions.
                                        </p>
                                        <div class="kt-widget5__info">
                                            <span>Author:</span>
                                            <span class="kt-font-info">Youaccounts</span>
                ...
                <div class="tab-content">
                        ...
                        <div class="kt-widget4">
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_4.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Anna Strong
                                    </a>
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-brand btn-bold">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_14.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Milano Esco
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-warning btn-bold">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_11.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Nick Bold
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-danger btn-bold">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_1.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Wiltor Delton
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-success btn-bold">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_5.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Nick Stone
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-primary btn-bold">Follow</a>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="kt_widget4_tab2_content">
                        <div class="kt-widget4">
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_2.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Kristika Bold
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-success">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_13.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Ron Silk
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-brand">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_9.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Nick Bold
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-danger">Follow</a>
                            </div>
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_2.jpg" alt="">
                            ...
                            <div class="kt-widget4__item">
                                <div class="kt-widget4__pic kt-widget4__pic--pic">
                                    <img src="<? themeUrl()?>assets/media/users/100_8.jpg" alt="">
                                </div>
                                <div class="kt-widget4__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget4__username">
                                        Nick Bold
                                ...
                                <a href="<?php echo base_url()?>" class="btn btn-sm btn-label-info">Follow</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="kt-widget2">
                            <div class="kt-widget2__item kt-widget2__item--primary">
                                ...
                                <div class="kt-widget2__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget2__title">
                                        Youaccounts is your best business companion
                                    </a>
                                    <a href="<?php echo base_url()?>" class="kt-widget2__username">
                                        By Bob
                                    </a>
                                </div>
                                <div class="kt-widget2__actions">
                                    <a href="<?php echo base_url()?>" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
                                        <i class="flaticon-more-1"></i>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                                        <ul class="kt-nav">
                            ...
                            <div class="kt-widget2__item kt-widget2__item--success">
                                ...
                                <div class="kt-widget2__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget2__title">
                                        Youaccounts is a powerful tool for your business analysis.
                                    </a>
                    ...
                    <div class="tab-pane" id="kt_widget2_tab2_content">
                        <div class="kt-widget2">
                            <div class="kt-widget2__item kt-widget2__item--success">
                                ...
                                <div class="kt-widget2__info">
                                    <a href="<?php echo base_url()?>" class="kt-widget2__title">
                                        Youaccounts makes you comfortable.
                                    </a>
                                    <a class="kt-widget2__username">
                                        By Youaccounts
                                    </a>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="kt_widget6_tab1_content" aria-expanded="true">
                        <div class="kt-notification">
                            <a href="<?php echo base_url()?>" class="kt-notification__item">
            ...
            <div class="kt-portlet__body">
                <div class="kt-widget3">
                    <div class="kt-widget3__item">
                        <div class="kt-widget3__header">
                            <div class="kt-widget3__user-img">
                                <img class="kt-widget3__img" src="<? themeUrl()?>assets/media/users/user1.jpg" alt="">
                            </div>
                            <div class="kt-widget3__info">
                                <a href="<?php echo base_url()?>" class="kt-widget3__username">
                                    Melania Trump
                                </a><br>
                    ...
                    <div class="kt-widget3__item">
                        <div class="kt-widget3__header">
                            <div class="kt-widget3__user-img">
                                <img class="kt-widget3__img" src="<? themeUrl()?>assets/media/users/user4.jpg" alt="">
                            </div>
                            <div class="kt-widget3__info">
                                <a href="<?php echo base_url()?>" class="kt-widget3__username">
                                    Lebron King James
                    ...
                    <div class="kt-widget3__item">
                        <div class="kt-widget3__header">
                            <div class="kt-widget3__user-img">
                                <img class="kt-widget3__img" src="<? themeUrl()?>assets/media/users/user5.jpg" alt="">
                            </div>
                            <div class="kt-widget3__info">
                                <a href="<?php echo base_url()?>" class="kt-widget3__username">
                                    Deb Gibson
...
<?php 
roAddJsBind(getPageUrl('dashboard-data').'&api=true');
?>