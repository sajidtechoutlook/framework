...
var KTDashboard = function() {
    ...
    var activitiesChart = function() {
        ...
        var config = {
            type: 'line',
            data: {
                labels: ["<?php echo ro_date('d, M Y', time()-(86400*6))?>", "<?php echo ro_date('d, M Y', time()-(86400*5))?>", "<?php echo ro_date('d, M Y', time()-(86400*4))?>", "<?php echo ro_date('d, M Y', time()-(86400*3))?>", "<?php echo ro_date('d, M Y', time()-(86400*2))?>", "<?php echo ro_date('d, M Y', time()-(86400*1))?>", "<?php echo ro_date('d, M Y')?>"],
                datasets: [{
                    label: "Sales Stats",
                    ...
                    //fill: 'start',
                    data: [
                        <?php echo getSalesAmount(ro_date('Y-m-d 00:00:00', time()-(86400*6)), ro_date('Y-m-d 23:59:59', time()-(86400*6)))?>, <?php echo getSalesAmount(ro_date('Y-m-d 00:00:00', time()-(86400*5)), ro_date('Y-m-d 23:59:59', time()-(86400*5)))?>, <?php echo getSalesAmount(ro_date('Y-m-d 00:00:00', time()-(86400*4)), ro_date('Y-m-d 23:59:59', time()-(86400*4)))?>, <?php echo getSalesAmount(ro_date('Y-m-d 00:00:00', time()-(86400*3)), ro_date('Y-m-d 23:59:59', time()-(86400*3)))?>, <?php echo getSalesAmount(ro_date('Y-m-d 00:00:00', time()-(86400*2)), ro_date('Y-m-d 23:59:59', time()-(86400*2)))?>, <?php echo getSalesAmount(ro_date('Y-m-d 00:00:00', time()-(86400*1)), ro_date('Y-m-d 23:59:59', time()-(86400*1)))?>, <?php echo getSalesAmount(ro_date('Y-m-d 00:00:00'), ro_date('Y-m-d 23:59:59'))?>
                    ]
                }]
            },
            options: {
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    //fill: 'start',
                    data: [
                        <?php echo getPayments(ro_date('Y-m-d 00:00:00', time()-(86400*6)), ro_date('Y-m-d 23:59:59', time()-(86400*6)))?>, <?php echo getPayments(ro_date('Y-m-d 00:00:00', time()-(86400*5)), ro_date('Y-m-d 23:59:59', time()-(86400*5)))?>, <?php echo getPayments(ro_date('Y-m-d 00:00:00', time()-(86400*4)), ro_date('Y-m-d 23:59:59', time()-(86400*4)))?>, <?php echo getPayments(ro_date('Y-m-d 00:00:00', time()-(86400*3)), ro_date('Y-m-d 23:59:59', time()-(86400*3)))?>, <?php echo getPayments(ro_date('Y-m-d 00:00:00', time()-(86400*2)), ro_date('Y-m-d 23:59:59', time()-(86400*2)))?>, <?php echo getPayments(ro_date('Y-m-d 00:00:00', time()-(86400*1)), ro_date('Y-m-d 23:59:59', time()-(86400*1)))?>, <?php echo getPayments(ro_date('Y-m-d 00:00:00'), ro_date('Y-m-d 23:59:59'))?>
                    ]
                }]
            },
            options: {
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    //fill: 'start',
                    data: [
                        <?php echo getSales(ro_date('Y-m-d 00:00:00', time()-(86400*6)), ro_date('Y-m-d 23:59:59', time()-(86400*6)))?>, <?php echo getSales(ro_date('Y-m-d 00:00:00', time()-(86400*5)), ro_date('Y-m-d 23:59:59', time()-(86400*5)))?>, <?php echo getSales(ro_date('Y-m-d 00:00:00', time()-(86400*4)), ro_date('Y-m-d 23:59:59', time()-(86400*4)))?>, <?php echo getSales(ro_date('Y-m-d 00:00:00', time()-(86400*3)), ro_date('Y-m-d 23:59:59', time()-(86400*3)))?>, <?php echo getSales(ro_date('Y-m-d 00:00:00', time()-(86400*2)), ro_date('Y-m-d 23:59:59', time()-(86400*2)))?>, <?php echo getSales(ro_date('Y-m-d 00:00:00', time()-(86400*1)), ro_date('Y-m-d 23:59:59', time()-(86400*1)))?>, <?php echo getSales(ro_date('Y-m-d 00:00:00'), ro_date('Y-m-d 23:59:59'))?>
                    ]
                }]
            },
            options: {
