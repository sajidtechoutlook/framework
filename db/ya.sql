...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2022 at 09:51 AM
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '', '', '', '', 16, '0000-00-00 00:00:00', 1, '', 0, '', 0, 0, '0000-00-00 00:00:00', '<h1>YOU ACCOUNTS</h1>', 'Powered by <a href=\"http://youaccounts.com\">You Accounts</a>', 0, 'ITEM', 'BRAND', 'SIZE', '', '', '', 0, 'VFdwQmVVMXBNSGROVXpCNlRWRTlQUT09', 0);
...
--
-- Indexes for table `ro_0_w_payment`
--
ALTER TABLE `ro_0_w_payment`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ro_0_w_payment`
--
ALTER TABLE `ro_0_w_payment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
